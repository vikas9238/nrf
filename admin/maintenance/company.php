...
<script>
	$(document).ready(function() {
		$('#create_new').click(function() {
			uni_modal("<i class='fa fa-plus'></i> Add New company", 'maintenance/manage_company.php')
		})
		$('.edit_data').click(function() {
			uni_modal("<i class='fa fa-edit'></i> Edit company's Details", 'maintenance/manage_company.php?id=' + $(this).attr('data-id'))
		})
