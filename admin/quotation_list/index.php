...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=quotation_list/manage_quotation" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Create New</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	...
	function delete_quotation($id) {
		start_loader();
		$.ajax({
			url: _base_url_ + "classes/Master.php?f=delete_quotation",
			method: "POST",
			data: {
				id: $id
			},
