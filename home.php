                            ...
                            <a class="col mb-5 text-decoration-none text-dark" id="quotation" href=".?p=view_quotation&id=<?php echo md5($row['id']) ?>">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        ...
                                        <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3"><?php echo $row['category'] ?></div>
                                    </div>
                                    <div class="p-4 pb-0">
                                    <?php if (isset($_SESSION['userdata']['id'])) : ?>
                                        <p class="text-primary mb-3">&#8377;<?php echo $row['daily_rate'] ?></p>
                                    <?php endif; ?>
