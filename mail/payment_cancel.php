...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST['name']) && !empty($_POST['email'])) {
    ...
    <div style='background-color: #fff;margin: 0 auto;padding: 20px;max-width: 600px;border: 1px solid #ddd;'>
        ...
        <div style='padding: 20px;'>
            ...
            <p style='font-size: 14px;line-height: 1.6;'>We regret to inform you that your recent payment has been identified as invalid following our verification process. Therefore, we are canceling your material booking request.</p>
