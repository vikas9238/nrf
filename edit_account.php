                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-body box-profile">
                                        <div class="text-center">
                                            <img class="profile-user-img img-fluid img-circle" src="<?php echo base_url . 'uploads/clients/' . $_settings->userdata('id') . '/' . 'user.png' ?>" alt="User profile picture">
                                        </div>

                                        <h3 class="profile-username text-center"><?php echo $_settings->userdata('firstname'), $_settings->userdata('lastname') ?></h3>
                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-body box-profile">
                                        <div class="text-center">
                                            <img class="img-fluid" src="<?php echo base_url . 'uploads/clients/' . $_settings->userdata('id') . '/' . 'sign.png' ?>" alt="Signature">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                </div>
